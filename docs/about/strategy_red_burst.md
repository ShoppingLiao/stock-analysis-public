...
|------|------|---------|--------|------|------|
| 1 | V0 | D4/D5 驗證後 D5 進場 | +6.10% | 42.7% | 5044 |
| 2 | V1 | D1 收盤直接進場(漲停則 D2 開盤)| +6.95% | 43.6% | 11465 |
| 3 | **V1+dedupe**(現役)| 同檔持有期間不重複 | **+7.01%** | **45.9%** | **4623** |

> 樣本 V1 重複版最大,但那是「同檔多筆同時進場」放大,
> 實戰一倉一筆才能拿到 V1+dedupe 的乾淨數字。
